...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/android-1.0.9-3DDC84" alt="Android 1.0.9">
</p>
...
| Languages | 15 bundled languages, 1103 keys each, following the device and overridable in the app |
...
- 364 node tests over pure product logic — deck physics, chat timeline shaping, reliability classification, dial geometry, unsent-message queue, design-token contrast in both schemes
...
The repository is 59 migrations, 69 modules under
