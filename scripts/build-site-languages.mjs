...
for (const locale of siteLocales) {
  ...
  // die Auswahl nichts erfindet, hoechstens sechs zeigt und mit der Sprache
  ...
  if (gezeigt.length > 6) problems.push(`${label}/index.html shows ${gezeigt.length} languages on the home page; six is the limit.`);
