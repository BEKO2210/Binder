...
export function BinderScreenHeader({ title, titleVisual, eyebrow, leading, trailing, centered = false, onTitlePress, titleAccessibilityLabel, style }: Props) {
  ...
  return (
    <View style={[{ minHeight: theme.layout.screenHeaderHeight, paddingHorizontal: theme.spacing.screen, flexDirection: 'row', alignItems: 'center', gap: theme.spacing.x2, borderBottomWidth: 1, borderBottomColor: theme.colors.borderSubtle, backgroundColor: theme.colors.canvas }, style]}>
