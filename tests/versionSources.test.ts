...
// android/ is generated by prebuild and not in the repository, so on a fresh
// checkout there is nothing to compare against — and a check that quietly
// passes because a file is missing is not a check. It is compared where it
